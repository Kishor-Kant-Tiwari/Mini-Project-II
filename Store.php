...
$text = $food."::".$name."::".$email."::". $phone."::".$quantity."::".$message."::\r\n";

	echo "<h2><center>Thank you Your Order is Successfully Placed<center></h2><br>";
	echo "<h2><center>Your Order Number is $j_a_n</center></h2><br>";
